    ...
    <div className="start-overlay">
      <div className="start-panel">
        ...
        <div className="social-links">
          <a href="https://linkedin.com/in/kartik-maheshwari-267ba5376" target="_blank" rel="noopener noreferrer" className="social-icon">
          ...
          <a href="https://github.com/kartik11m" target="_blank" rel="noopener noreferrer" className="social-icon">
